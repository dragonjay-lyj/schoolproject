import {
  ...
  const MyNavbar = () => {
    return (
      <Navbar>
        <NavbarBrand>
          <Avatar src="https://res.cloudinary.com/dkhp3hucr/image/upload/v1711180675/dev/QmQqXgZAbEZbegbGS3zpo99XozzqA5YNwNL1W5NPRvRHVS_laizvj.png" alt="Logo" />
        </NavbarBrand>
        <NavbarContent className="hidden sm:flex gap-4" justify="center">
          ...
          <NavbarItem><Button href="/link" as={Link} color="foreground" isBlock className="text-white" ><span className="icon-[heroicons--link-16-solid]"></span>友链</Button></NavbarItem>
        ...
        <NavbarMenu>
          ...
          <NavbarMenuItem><Button href="/link" as={Link} color="foreground" isBlock className="text-white" ><span className="icon-[heroicons--link-16-solid]"></span>友链</Button></NavbarMenuItem>
